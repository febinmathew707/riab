 ...
 <table border="0" cellpadding="0" cellspacing="0"  width="100%" >
   ...
   <tr>
     <td width="100%"  align="left" valign="bottom" bgcolor="#FFFFFF" colspan=2>
		...
		<embed width=1002 height=147 src='movies/head.swf' allowScriptAccess="sameDomain" type="application/x-shockwave-flash" SWLIVECONNECT="true" pluginspage="http://www.adobe.com/go/getflashplayer" /></td>
   </tr>
   </table>
 </td>
 </tr> 
