...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="100%" id="AutoNumber2"  bgcolor="#FFFFFF">    
	    <tr>
         ...
         <?php
	 		if(isset($_SESSION["ed_bud_id"]))
	 		{
				$id=$_SESSION["ed_bud_id"];
			}
			else
			{
				$id=0;
			...
			//echo $id;
	 		...
	 		{
	 		?>
         <table border="0" cellspacing="1" style="border-collapse: collapse" bordercolor="#111111" width="98%" 
		 id="AutoNumber1" >
  <tr>
     <td width="100%" align="left"   height="39" valign=top>	 
	 <font face=verdana color=black size=2><b> Annual Budget </b></font>
	 <br>
	 </td>
   </tr>
	 <tr>
     ...
     <select name="cmbCompany" id="cmbCompany"  onchange="dispbudget('actual')">   
   ...
   <tr>
     ...
     <td width="2%" height="27"></td>
     <td width="68%" height="27"><input type="button" value="update" onclick="updateBudget('actual',0)"></td>
   </tr>
   </table>
     </td>
     </tr>     
 ...
 <?php
 	...
 	{
 		$strsql="select * from emp_actual_budget where bud_id=".$id."";
  ...
  <tr>
	 ...
	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana color=black size=2><b> Actual Budget Master</b></font>
	 </td>
   </tr>
	 <tr>
     <td width="100%" align="center"   height="63" valign="top" background="images/createaccountmiddle.gif">
		 ...
		 id="AutoNumber1" bgcolor="#FFFFFF" cellpadding="4">      
   	<tr>
     <td width="30%" align="right" height="23" class="txtright">
     <font color="#000000">Company</font></td>
     <td width="2%" height="23">:</td>
     <td width="68%" height="23">
     <select name="cmbCompany" id="cmbCompany" onclick="dispbudget('actual')" onchange="dispbudget('actual')">   
...
&nbsp;</td>
   ...
   <tr>
     ...
     <td width="68%" height="27">
	 <?php echo"
	 			<input type='button' value='update' onclick=updateBudget('actual',".$rowbud["bud_id"].")>";
	?>
