<?php session_start();
	...
	elseif($_SESSION['LogType']!='HR' && $_SESSION['LogType']!='CO')
	{
		Header("Location: home.php");
		die();
	}
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111"  id="AutoNumber4" height="163" width=90%>
               <tr>
                 <td  background="images/innertop.gif" height="49" valign="top">
                 
                 <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111"  id="AutoNumber7" height="25">
                   <tr>
                     <td width="10"  class="heading" ><font color=black>&nbsp;
                     </td>
					 <td width="10"  class="txtleft" valign=top align=right>
					 	 
					 </td>
                     <td width="100" valign="bottom" align="right" class="heading">
                     	Add Profile
					 </td>
                   </tr>
                 </table>
               ...
               <tr>
                 <td  background="images/innermiddle.gif" height="121" valign="top" 
				 align=center>        
				 ...
				 <table border="0" cellpadding="5" cellspacing="0" style="border-collapse: collapse" bordercolor="#C0C0C0"  id="AutoNumber5" height="1">
                   <tr>
                     <td width="0" bgcolor="#FFFFFF" bordercolor="#C0C0C0" height="1" 
				...
				<?php echo "<input type=text id=txtMaritalStatus 
                   ...
                   <tr>
                     ...
                     <td width="0" bgcolor="#FFFFFF" bordercolor="#C0C0C0" height="1"
					  background="images/rowbg3.gif" class="txtleft">&nbsp;
					<?php echo "<input type=text id=txtExp  class=txtbox size=40>"; ?></td>
                   </tr>
                   <tr>
                     <td width="0" bgcolor="#FFFFFF" bordercolor="#C0C0C0" height="1"
					  background="images/rowbg1.gif" class="txtright1">
                   ...
                   <tr>
                     <td width="0"  bordercolor="#C0C0C0" height="1" colspan="3" align=right>
