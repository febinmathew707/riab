  ...
  <tr>
     ...
     <td width="100%" align="center"  background="images/createaccountmiddle.gif" height="30" valign="bottom">     
		...
		<table border="1" cellspacing="0" style="border-collapse: collapse" bordercolor="#E2E0E0" width="85%" id="AutoNumber1" bgcolor="#FFFFFF" cellpadding="4">
		 ...
		 <td width="10%" align="right" height="23" class="txtleft"> <b> Sales</b>
		 </td>
		 <td width="10%" align="right" height="23" class="txtleft"> <b> Stock</b>
		 </td>
		 <td width="10%" align="right" height="23" class="txtleft"> <b> Date</b>
		 </td>
     	...
     	<?php
     		if($company==0 && $finyear==0)
     		{
     			$strsql="SELECT * FROM emp_reversed_budget ";
			}
			else if($company>0 && $finyear==0)
			{
			...
			{
				$strsql="SELECT * FROM emp_reversed_budget where fin_year=".$finyear." order by company_id,
				fin_year,bud_rev_id 
				desc";
			}
			else if($company>0 && $finyear>0)
			{
				$strsql="SELECT * FROM emp_reversed_budget where company_id=".$company." and fin_year=".$finyear."
				 order by bud_rev_id desc";
			}
			//echo $strsql;
    ...
    <td width="10%" align="right" height="23" class="txtleft">
     <?php echo $row["sales"];
     ?>
    </td>
    <td width="10%" align="right" height="23" class="txtleft">
    ...
    <td width="5%" align="right" height="23" class="txtright">
    	<?php 
    		echo "<a href=JavaScript:edit('revbudget',".$row["bud_rev_id"].")>";
		?><img src="img_new/edit.gif" alt="editcompany" border="0"></a>
    </td>
    <td width="5%" align="right" height="23" class="txtright">
    	<?php 
    		echo "<a href=JavaScript:del('revbudget',".$row["bud_rev_id"].")>";
