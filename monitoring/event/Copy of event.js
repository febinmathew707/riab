...
function expand(str)
{
	...
	switch(str)
	{
		...
		case "stage":
					if (statype==1)
					{
						document.getElementById("st").innerHTML="<img src='images/mvstageshows.gif'><input type='image' src='images/arrow1.gif' onclick=expand('stage')>"
					...
					{
						document.getElementById("st").innerHTML="<img src='images/mvstageshows.gif'><input type='image' src='images/arrow.gif' onclick=expand('stage')>"
