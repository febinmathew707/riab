...
onload=getStateRb('postdate','',1,1,1)>"; 
 ...
 <td width="100%"  valign=top align=center height="100%">
   ...
   <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="961" id="AutoNumber1" bgcolor="#000000">
     <tr>
       <td width="961" height="104" align="left" valign="bottom" >
	    <br><br>
       <!-- <font face="Verdana" size="1" color="#9C9898"> <b><a href="http://www.wavesatlive.com" >Waivesat Home</a> |<a href="Javascript:filt('','')"> Featured Videos </a> |<a href="aboutevents.php">About Waivesat Events </a> |  
	   <a href="../contact.php">Contact Us</a></b></font>&nbsp;&nbsp;&nbsp;-->
	   	<table width=100% cellpadding="1" cellspacing="1" border=0 bordercolor="#FFFFFF"  >
	   		<tr>
		<td valign="bottom" align=left class="txtleft" width=100%><img src="images/videogallery.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;	
		Search Videos
		<?php if (isset($_SESSION["cap"]))
		 	...
		 	if($_SESSION["cap"]!="")
		 	{
			 	echo "<input type=text id=txtSearch name=txtSearch class=txtboxblack size=80 
