...
function BasicTable($header,$data)
{
   ...
   ////////////////////////////////////  HEADING /////////////////////////////
	...
	$this->Cell(188,6,"UNITS THAT INCREASED PROFIT",0,0,'C');
	$this->ln();
   ...
   $strsql="select company_id from 
    ...
    while($row=mysql_fetch_array($result))
    {
		...
		if($rowcheck[0]=="A")
		{
			...
			if($pandl>0 && $prepandl>0 && $pandl>$prepandl)
			{
				...
				if(strlen($rowcom["company_name"])>55)
		    {
				...
				$this->Cell(60,4,substr($rowcom["company_name"],0,55),"R",0,'L');
			...
			else
			{
				...
				$this->Cell(60,4,substr($rowcom["company_name"],0,55),"R,B",0,'L');
			}		
					//$this->Cell(10,4,$slno,"L,R,B",0,'C');
