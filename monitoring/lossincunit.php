...
function BasicTable($header,$data)
{
  ...
  // $this->Cell(100,7,$fyear,1);
   ////////////////////////////////////  HEADING /////////////////////////////
	...
	$this->Cell(190,6,"LOSS INCURING UNITS",0,0,'C');
	$this->ln();
...
mysql_query($strsql); 
    ...
    $strsql="select company_id from 
			emp_monthly_report where fin_year=".$tyear." and month=".$tmth." and cumulative_net_profit<=0 and status='A'   order by cumulative_net_profit desc";
