...
order by t1.fin_year*/
      ...
      <tr>
        <td width="180" height="31" class="txtleft">
        <b>3. Capacity/Production<br>&nbsp;&nbsp;&nbsp;&nbsp;details of current year</b></td>
        ...
        <table border="1" cellpadding="3" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="64">
          ...
          <tr>
          	<td width="20%" height="40" class="txtcenter1" bgcolor="#D7D7D7">
            Product 
            </td>
            <td width="14%" height="40" class="txtcenter1" bgcolor="#D7D7D7">
            Installed capacity per annum<br>
            </td>
            <td width="14%" height="40" class="txtcenter1" bgcolor="#D7D7D7">
            Achievable capacity <br>per annum<br>
            </td>
            <td width="8%" height="40" class="txtcenter1" bgcolor="#D7D7D7">Capacity 
            being <br>
            used now<br>
            </td>
            <td width="8%" height="40" class="txtcenter1" bgcolor="#D7D7D7">Machine <br>
            Efficiency (%)</td>
            <td width="10%" height="40" class="txtcenter1" bgcolor="#D7D7D7">Capacity<br>
            Utilisation (%)</td>
			<td width="13%" height="40" class="txtcenter1" bgcolor="#D7D7D7">Production<br>
            current<br>Month(Qty)</td>
			<td width="13%" height="40" class="txtcenter1" bgcolor="#D7D7D7">Production<br>
            last year<br> Current<br>Month(Qty)</td>
            </tr>
          <?php
          ...
          <tr>
            ...
            <td width="10%" height="23" class="txtcenter1" >
			...
			<td width="10%" height="23" class="txtcenter1" >
            	<?php echo "<input type=text id='txtCurrMonthPrdn' name='txtCurrMonthPrdn' size=10 
				class=txtboxwhite value=".$rowPro["actual_prod"]." 
				>";
            	?>
            </td>
			<td width="10%" height="23" class="txtcenter1" >
            	<?php echo "<input type=text id='txtPreYearCurrMonthPrdn' name='txtPreYearCurrMonthPrdn' size=10 
				class=txtboxwhite value=".$rowPro["actual_pre_year_prod"]." 
				>";
            	?>
            </td>
          </tr>
      ...
      <tr>
        ...
        <table border="1" cellpadding="3" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="100%">
          ...
          <tr>
            <td width="500" class="txtleft">a) Sales</td>
