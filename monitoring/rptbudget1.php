...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="100%" id="AutoNumber2" height="116" bgcolor="#FFFFFF">      
	 ...
	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font face=verdana color=black size=2><b> Budget Master</b></font>
     </td>
   </tr>
	 <tr>
    ...
    ?>
          ...
          <tr>
            <td width="100%" align=center colspan="3"><input type=button value="show" 
			onclick="javascript:budgetMaster('budget.php')"> </td>
          </tr>
        </table>
        &nbsp;</td>
     </tr>
