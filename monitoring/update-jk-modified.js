...
{ 
	...
	for(i=1;i<=document.frmMonthlyReport.length-1;i++)
	{
		if(document.frmMonthlyReport.elements[i].name=="txtCurrMonthPrdn")
		{
			url=url+"&CurrMonthPrdn"+tot+"="+document.frmMonthlyReport.elements[i].value
			tot=tot+1
		}
	}
	tot=tot-1	
	url=url+"&totCurrMonthPrdn="+tot
	
	tot=1
	for(i=1;i<=document.frmMonthlyReport.length-1;i++)
	{
		if(document.frmMonthlyReport.elements[i].name=="txtPreYearCurrMonthPrdn")
		{
			url=url+"&PreYearCurrMonthPrdn"+tot+"="+document.frmMonthlyReport.elements[i].value
			tot=tot+1
		}
	}
	tot=tot-1	
	url=url+"&totPreYearCurrMonthPrdn="+tot
