 ...
 */	
	...
	{
		$actualrawmateactualrawmaterialrial=$_POST[""];
	}
	else
	{
		$actualrawmaterial=0;
	...
	$totcurrmonthprdnqty=$_POST["totcurrmonthprdnqty"];
	for($i=1;$i<=$totcurrmonthprdnqty;$i++)
	{
		$str="currmonthprdnqty".$i;
		//echo $str;
		$currmonthprdnqty[$i]=$_POST[$str];
	}
	

	$totcumprodqty=$_POST["totcumprodqty"];
	for($i=1;$i<=$totcumprodqty;$i++)
	{
		$str="cumprodqty".$i;
		//echo $str;
		$cumprodqty[$i]=$_POST[$str];
	}

	$totcurrmonthsaleqty=$_POST["totcurrmonthsaleqty"];
	for($i=1;$i<=$totcurrmonthsaleqty;$i++)
	{
		$str="currmonthsaleqty".$i;
		//echo $str;
		$currmonthsaleqty[$i]=$_POST[$str];
	}

	$totcumsaleqty=$_POST["totcumsaleqty"];
	for($i=1;$i<=$totcumsaleqty;$i++)
	{
		$str="cumsaleqty".$i;
		//echo $str;
		$cumsaleqty[$i]=$_POST[$str];
	}
	...
	{		
		...
		$row=mysql_fetch_assoc($result);
			...
			for($i=1;$i<=$totcapacityutilization;$i++)
			{
				...
				machine_efficiency,prod_qty_formonth,prod_qty_cum,sale_qty_formonth,sale_qty_cum,capacity_utilization,rpt_date,status,edate)values(";
				$strsql=$strsql." ".$rptid.",";
				$strsql=$strsql." ".$company.",";
				$strsql=$strsql." ".$finyear.",";
				$strsql=$strsql." ".$month.",";
				...
				if($currmonthprdnqty[$i]!="")
				{
					$strsql=$strsql." ".$currmonthprdnqty[$i].",";
				}
				else
				{
					$strsql=$strsql."0,";
				...
				if($currmonthsaleqty[$i]!="")
				{
					$strsql=$strsql." ".$currmonthsaleqty[$i].",";
	//echo "if aaaaaaaaaaaaa " ;			
	//exit();	
				}
				else
				{
