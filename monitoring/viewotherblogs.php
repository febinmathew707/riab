...
<table border="0" cellpadding="0" cellspacing="0" 
	style="border-collapse: collapse" width="95%" id="AutoNumber3" >
	    ...
	    <tr>
			<td valign="top"  width="100%" align="right"><br><img src="images/otherstopic.gif">
			</td>
		</tr>
        <tr>
	 ...
	 width="95%" id="AutoNumber3" >
		 <?php 
				...
				if(mysql_num_rows($result)<=0)
				{
					...
					<center>No Topics are posted by others !!</center></font><br><br>";
				...
				{ ?>
					...
					<tr>
					<td valign="top" class="blogtitle" width="100%" height=25>
        			<?php 
					...
					<tr>					
					<td valign="bottom"  width="100%" class="txtgrey">
						<?php 
						$strsql="select name from emp_user_setting where ID=".$row["user_id"]." ";
						$resultEmp=mysql_query($strsql);
						$rowEmp=mysql_fetch_assoc($resultEmp);
						if($rowEmp["name"]=="")
						{
							$strsql="select * from emp_user where Id=".$row["user_id"]."";
        				...
        				echo "Posted by ".$name. " on : " . date('d-m-Y',strtotime($row["post_date"]));
        			?>
					</td>
					</tr>
					</table>
        			...
        			<td width="100%" valign="top" align="left" height=10 class="blogs"  background="images/blogmiddle.gif">
        				<?php echo"<div id='comment".$row["bl_id"]."'></div>"
        				?>
					</td>
					</tr>
					<tr>
