<?php
 $source_image = imagecreatefrompng("images_small/red_middle.png");
 $first=imagecreatefrompng("images_small/red_left.png");
 $red_end=imagecreatefrompng("images_small/red_end.png");
  $width = imagesx($source_image);
  $height = imagesy($source_image);
  $background=imagecreatefrompng("images_small/bar.png");
 ...
 $w_offset = 0;
  ...
  // Overlay watermark
	...
	if($i<=99)
		$last=imagecreatefrompng("images_small/bar_behind_last.png");
	else
		$last=imagecreatefrompng("images_small/red_right.png");
